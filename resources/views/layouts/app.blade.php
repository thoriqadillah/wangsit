        ...
        <div class="hidden lg:flex items-center gap-8 text-xl text-mainColor">
            ...
            <div class="relative cursor-default group">
                <div class="flex items-center gap-2">
                    <h1 class="{{ (request()->is('admin/*')) ? 'after:content-[\'\'] after:w-full after:h-[2px] after:bg-mainColor after:absolute after:-bottom-1 after:rounded-full after:left-0 relative px-2' : 'hover:after:content-[\'\'] hover:after:w-full hover:after:h-[2px] hover:after:bg-mainColor hover:after:absolute hover:after:-bottom-1 hover:after:rounded-full hover:after:left-0 hover:relative  after:transition after:ease-in after:duration-500 px-2' }}">Admin</h1>
                ...
                <div class="absolute hidden -left-6 group-hover:block p-3 w-60">
                    <div class="flex flex-col gap-5 bg-white shadow-lg border p-5">
                        ...
                        <a class="hover:after:content-[''] hover:after:w-full hover:after:h-[2px] hover:after:bg-mainColor hover:after:absolute hover:after:-bottom-1 hover:after:rounded-full hover:after:left-0 hover:relative  after:transition after:ease-in after:duration-500 px-2" href="/admin/event">Event</a>
                        <a class="hover:after:content-[''] hover:after:w-full hover:after:h-[2px] hover:after:bg-mainColor hover:after:absolute hover:after:-bottom-1 hover:after:rounded-full hover:after:left-0 hover:relative  after:transition after:ease-in after:duration-500 px-2" href="/admin/academy">Academy</a>
                        @else
                        <a class="hover:after:content-[''] hover:after:w-full hover:after:h-[2px] hover:after:bg-mainColor hover:after:absolute hover:after:-bottom-1 hover:after:rounded-full hover:after:left-0 hover:relative  after:transition after:ease-in after:duration-500 px-2" href=" /admin/root">Root</a>
                        @endif
                    </div>
                </div>
            </div>
