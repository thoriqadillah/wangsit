...
<div class="px-8 lg:px-20 py-20 lg:py-28">
    <div>
        ...
        <form class="relative">
            ...
            <input onkeyup="filterModul()" id="searchAcademy" type="text" class="block mx-auto lg:w-[600px] w-full mt-4 lg:mt-10 rounded-full outline-mainColor border shadow py-2 pl-12 pr-4 lg:pl-16" placeholder="search" />
        </form>
    </div>
    ...
    <div class="grid grid-col-1 lg:grid-cols-3 mt-8 gap-8 lg:gap-16 lg:px-20">
        ...
        <div class="w-full shadow-xl modul">
            ...
            <div class="p-4">
                <div>
                    <h1 class="text-lg text-mainColor text-center">Dasar Basis Data</h1>
                </div>
                <button class="block w-full rounded-md shadow-md bg-mainColor text-center text-white py-3 mt-6">REGISTER</button>
            </div>
        </div>
        ...
        <div class="w-full shadow-xl modul">
            ...
            <div class="p-4">
                <div>
                    <h1 class="text-lg text-mainColor text-center">Pemrograman Lanjut</h1>
                </div>
                <button class="block w-full rounded-md shadow-md bg-mainColor text-center text-white py-3 mt-6">REGISTER</button>
            </div>
        </div>
        ...
        <div class="w-full shadow-xl modul">
            ...
            <div class="p-4">
                <div>
                    <h1 class="text-lg text-mainColor text-center">Pemrograman Dasar</h1>
                </div>
                <button class="block w-full rounded-md shadow-md bg-mainColor text-center text-white py-3 mt-6">REGISTER</button>
            </div>
        </div>
        ...
        <div class="w-full shadow-xl modul">
            ...
            <div class="p-4">
                <div>
                    <h1 class="text-lg text-mainColor text-center">Metodelogi Penelitian</h1>
                </div>
                <button class="block w-full rounded-md shadow-md bg-mainColor text-center text-white py-3 mt-6">REGISTER</button>
            </div>
        </div>
